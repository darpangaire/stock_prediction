...
from .views import UserRegistrationView,UserLoginView,register_view,email_verification_alert,login_view,verify_email_and_redirect,logout_view,test_user
...
urlpatterns = [
  ...
  path('test-user/', test_user, name='test_user'),
